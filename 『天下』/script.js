...
const KOTOBA_N5_CH5_1 = [
  ...
  ["ねます", "nemasu", { en: "sleep (polite)", id: "tidur (sopan)" }, "まいばん じゅういちじに ねます。",
    ...
    { en: "I sleep at eleven every night.", id: "Saya tidur jam sebelas setiap malam." }, "寝ます", "毎晩十一時に寝ます。",
    { en: "The dictionary form 寝る is an ichidan verb; its kanji 寝 also appears in ねぼう (寝坊, oversleeping).", id: "Bentuk kamus 寝る adalah kata kerja ichidan; kanji 寝-nya juga muncul pada ねぼう (寝坊, kesiangan bangun)." }]
];
...
// Sub-Tier 7.5: Kata Keterangan Derajat & Tata Bahasa (3)
const KOTOBA_N5_CH7_5 = [
  ...
  ["たくさん", "takusan", { en: "a lot, many", id: "banyak" }, "こうえんに ひとが たくさん います。",
    ...
    { en: "たくさん can also directly modify a following noun with の, as in たくさんの人 (many people).", id: "たくさん juga bisa langsung menerangkan kata benda setelahnya dengan の, seperti pada たくさんの人 (banyak orang)." }],
  ["もう", "mou", { en: "already", id: "sudah" }, "しゅくだいは もう おわりました。",
    ...
    { en: "もう means \"already\" with a positive verb, but shifts to mean \"not anymore\" when paired with a negative verb, as in もう たべません (I won't eat anymore).", id: "もう berarti \"sudah\" bila dipakai dengan kata kerja positif, tetapi berubah menjadi \"tidak lagi\" bila dipasangkan dengan kata kerja negatif, seperti pada もう たべません (saya tidak akan makan lagi)." }]
];
...
const KOTOBA_N5_LEVEL_TEXT = {
  tier1: { title: { en: "Tier 1.1 — Personal Pronouns & Greetings", id: "Tier 1.1 — Kata Ganti Orang & Sapaan" }, sample: "わたし あなた こんにちは", desc: { en: "53 N5 vocabulary words.", id: "53 kosakata N5." } },
  ...
  tier3: { title: { en: "Tier 1.3 — Occupations & Roles", id: "Tier 1.3 — Profesi & Peran" }, sample: "がくせい かいしゃいん", desc: { en: "25 N5 vocabulary words.", id: "25 kosakata N5." } },
  tier4: { title: { en: "Tier 2.1 — Daily Time & Time Expressions", id: "Tier 2.1 — Waktu Harian & Keterangan Waktu" }, sample: "いま きょう あした", desc: { en: "27 N5 vocabulary words.", id: "27 kosakata N5." } },
